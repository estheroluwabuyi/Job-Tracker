    ...
    <div className="min-h-screen bg-bg text-text flex items-center justify-center px-6 w-full">
      <div className="max-w-[40rem] w-full text-center">
        ...
        <motion.h1
          ...
          className="text-[2rem] sm:text-[2.5rem] font-semibold mb-5"
        >
        ...
        <motion.p
          ...
          className="text-text-secondary mb-8 tracking-wide text-[1.5rem]"
        >
        ...
        >
          <button
            onClick={() => navigate("/")}
            className="px-6 py-3 rounded-xl bg-primary text-bg hover:bg-primary-hover transition-colors duration-500 text-[1.5rem] font-medium"
          >
            Go Home
          </button>
          ...
          <button
            onClick={() => navigate(-1)}
            className="px-6 py-3 rounded-xl border border-primary-hover text-text/80 hover:bg-primary-light transition-colors duration-500 text-[1.5rem] font-medium"
          >
            Go Back
          </button>
        </motion.div>
